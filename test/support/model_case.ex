defmodule Elmelixirstarter.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import Elmelixirstarter.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&Elmelixirstarter.ErrorHelpers.translate_error/1)
